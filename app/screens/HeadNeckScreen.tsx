...
export default function App() {
  ...
  const filteredData = data.filter(item => item.category_id === 19);
  ...
  return (
    ...
    <Image source={require('../../assets/images/interfaceIcons_Artboard4.png')}style={{ width: 250, height: 250, justifyContent: 'center',}} />
    <Text style={{ color: '#FFF', fontSize: 20, marginTop: 10, marginBottom:15, textAlign:"center"}}>HEAD AND NECK DISSECTION VIDEOS</Text>
