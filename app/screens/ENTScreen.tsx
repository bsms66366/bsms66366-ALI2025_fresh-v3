...
export default function App() {
  ...
  return (
    ...
    <Image source={require('../../assets/images/interfaceIcons_Artboard35.png')}style={{ width: 250, height: 250, justifyContent: 'center',}} />
   
    <Text style={{ color: '#FFF', fontSize: 20, marginTop: 10, marginBottom:15, textAlign:"center"}}>ENT DISSECTION VIDEOS</Text>
